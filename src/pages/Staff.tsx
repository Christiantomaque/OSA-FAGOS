            ...
            <div className="bg-[#171717] border border-[#2e2e2e] p-6 rounded-xl shadow-lg">
              ...
              <form onSubmit={handleSubmit(onTaskSubmit)} className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    <option value="me">Me ({user?.displayName || 'Staff'})</option>
          ...
          <div className="space-y-8">
            ...
            <div className="border border-[#2e2e2e] rounded-xl bg-[#171717] overflow-hidden">
               <table className="w-full text-left text-sm whitespace-nowrap">
                  ...
                  <tbody className="divide-y divide-[#2e2e2e]">
                    {historyTasks.length === 0 ? <tr><td colSpan={4} className="p-10 text-center text-[#a1a1a1]">No task history available</td></tr> : historyTasks.map(t => (
