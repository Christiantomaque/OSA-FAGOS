                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <div className="flex items-center gap-3 text-[#a1a1a1] text-[10px] uppercase font-bold">
                                      ...
                                      <span className={isFull ? 'text-[#a1a1a1]' : 'text-[#3ecf8e]'}>{formatDynamicTimeDisplay(Number(t.duration) * 3600)}</span>
                                    </div>
                                  </button>
                                );
                              })
            ...
            {selectedTask && (
              <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="mt-4 p-5 rounded-lg bg-[#1c1c1c] border border-[#2e2e2e] space-y-4">
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div><div className="text-[9px] uppercase font-bold text-[#a1a1a1] mb-1">Duration</div><div className="text-sm font-bold text-[#3ecf8e]">{formatDynamicTimeDisplay(Number(selectedTask.duration) * 3600)}</div></div>
                </div>
