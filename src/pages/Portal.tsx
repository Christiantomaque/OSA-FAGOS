        ...
        <div className="border-b border-[#2e2e2e] bg-[#1c1c1c] p-6 sm:p-10">
          <div className="flex items-center justify-between gap-2 sm:gap-4 max-w-2xl mx-auto">
            ...
            <img 
              src={cdmLogo} 
              alt="CDM Logo" 
              className="w-12 h-12 sm:w-20 sm:h-20 -mt-1 object-contain shrink-0 drop-shadow-md" 
            />
            ...
            <img 
              src={osaLogo} 
              alt="OSA Logo" 
              className="w-12 h-12 sm:w-20 sm:h-20 -mt-1 object-contain shrink-0 drop-shadow-md scale-170 origin-top" 
            />
